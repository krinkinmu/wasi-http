...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:component:http-proxy:proxy:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7045] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x896\x01A\x02\x01A#\x01\
...
\0\x06handle\x01\x06\x04\0\x20wasi:http/incoming-handler@0.2.2\x05\x16\x04\0\x1a\
component:http-proxy/proxy\x04\0\x0b\x0b\x01\0\x05proxy\x03\0\0\0G\x09producers\x01\
