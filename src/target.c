...
// Exported Functions from `wasi:http/incoming-handler@0.2.2`
...
void target_list_u32_free(target_list_u32_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void target_list_u8_free(target_list_u8_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void wasi_http_types_method_free(wasi_http_types_method_t *ptr) {
  switch ((int32_t) ptr->tag) {
    case 9: {
      target_string_free(&ptr->val.other);
      break;
    }
  }
}
...
void target_option_string_free(target_option_string_t *ptr) {
  if (ptr->is_some) {
    target_string_free(&ptr->val);
  }
}

void target_option_u16_free(target_option_u16_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_dns_error_payload_free(wasi_http_types_dns_error_payload_t *ptr) {
  target_option_string_free(&ptr->rcode);
  target_option_u16_free(&ptr->info_code);
}

void target_option_u8_free(target_option_u8_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_tls_alert_received_payload_free(wasi_http_types_tls_alert_received_payload_t *ptr) {
  target_option_u8_free(&ptr->alert_id);
  target_option_string_free(&ptr->alert_message);
}

void target_option_u32_free(target_option_u32_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_field_size_payload_free(wasi_http_types_field_size_payload_t *ptr) {
  target_option_string_free(&ptr->field_name);
  target_option_u32_free(&ptr->field_size);
}

void target_option_u64_free(target_option_u64_t *ptr) {
  if (ptr->is_some) {
  }
}
...
void wasi_http_types_error_code_free(wasi_http_types_error_code_t *ptr) {
  switch ((int32_t) ptr->tag) {
    ...
    case 17: {
      target_option_u64_free(&ptr->val.http_request_body_size);
      break;
    }
    case 21: {
      target_option_u32_free(&ptr->val.http_request_header_section_size);
      break;
    }
    case 22: {
    ...
    case 23: {
      target_option_u32_free(&ptr->val.http_request_trailer_section_size);
      break;
    }
    case 24: {
    ...
    case 26: {
      target_option_u32_free(&ptr->val.http_response_header_section_size);
      break;
    }
    case 27: {
    ...
    case 28: {
      target_option_u64_free(&ptr->val.http_response_body_size);
      break;
    }
    case 29: {
      target_option_u32_free(&ptr->val.http_response_trailer_section_size);
      break;
    }
    case 30: {
    ...
    case 31: {
      target_option_string_free(&ptr->val.http_response_transfer_coding);
      break;
    }
    case 32: {
      target_option_string_free(&ptr->val.http_response_content_coding);
      break;
    }
    case 38: {
      target_option_string_free(&ptr->val.internal_error);
      break;
    }
  }
}
...
void target_tuple2_field_name_field_value_free(target_tuple2_field_name_field_value_t *ptr) {
  wasi_http_types_field_name_free(&ptr->f0);
  wasi_http_types_field_value_free(&ptr->f1);
}

void target_list_tuple2_field_name_field_value_free(target_list_tuple2_field_name_field_value_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
    target_tuple2_field_name_field_value_t *list_ptr = ptr->ptr;
    for (size_t i = 0; i < list_len; i++) {
      target_tuple2_field_name_field_value_free(&list_ptr[i]);
    }
    free(list_ptr);
  }
}
...
void target_list_field_value_free(target_list_field_value_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void target_option_duration_free(target_option_duration_t *ptr) {
  if (ptr->is_some) {
  }
}
...
void target_string_set(target_string_t *ret, const char*s) {
  ret->ptr = (uint8_t*) s;
  ret->len = strlen(s);
}

void target_string_dup(target_string_t *ret, const char*s) {
  ret->len = strlen(s);
  ret->ptr = (uint8_t*) cabi_realloc(NULL, 0, 1, ret->len * 1);
  memcpy(ret->ptr, s, ret->len * 1);
}

void target_string_free(target_string_t *ret) {
  if (ret->len > 0) {
    free(ret->ptr);
  }
  ret->ptr = NULL;
...
void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, target_list_u32_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_io_poll_poll((uint8_t *) (*in).ptr, (*in).len, ptr);
  *ret = (target_list_u32_t) { (uint32_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_random_random_get_random_bytes(uint64_t len, target_list_u8_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_random_random_get_random_bytes((int64_t) (len), ptr);
  *ret = (target_list_u8_t) { (uint8_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, target_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_io_error_method_error_to_debug_string((self).__handle, ptr);
  *ret = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}

bool wasi_io_streams_method_input_stream_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, target_list_u8_t *ret, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (target_list_u8_t) { (uint8_t*)(*((uint8_t **) (ptr + 4))), (*((size_t*) (ptr + 8))) };
      break;
    }
    case 1: {
      result.is_err = true;
...
bool wasi_io_streams_method_input_stream_blocking_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, target_list_u8_t *ret, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, target_list_u8_t *contents, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, target_list_u8_t *contents, wasi_io_streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 1: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option.is_some = true;
              option.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          target_option_u16_t option0;
        ...
        case 14: {
          ...
          target_option_string_t option2;
          switch ((int32_t) *((uint8_t*) (ptr + 20))) {
            ...
            case 1: {
              ...
              option2.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 24))), (*((size_t*) (ptr + 28))) };
              break;
            }
          }
        ...
        case 22: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              ...
              target_option_string_t option5;
              switch ((int32_t) *((uint8_t*) (ptr + 20))) {
                case 0: {
                ...
                case 1: {
                  ...
                  option5.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 24))), (*((size_t*) (ptr + 28))) };
                  break;
                }
              }
              target_option_u32_t option6;
        ...
        case 24: {
          target_option_string_t option9;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option9.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          target_option_u32_t option10;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
        ...
        case 27: {
          target_option_string_t option12;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option12.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          target_option_u32_t option13;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
        ...
        case 30: {
          target_option_string_t option16;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option16.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          target_option_u32_t option17;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
        ...
        case 31: {
          target_option_string_t option18;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option18.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 32: {
          target_option_string_t option19;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option19.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 38: {
          target_option_string_t option20;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option20.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
...
bool wasi_http_types_static_fields_from_list(target_list_tuple2_field_name_field_value_t *entries, wasi_http_types_own_fields_t *ret, wasi_http_types_header_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, target_list_field_value_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_fields_get((self).__handle, (uint8_t *) (*name).ptr, (*name).len, ptr);
  *ret = (target_list_field_value_t) { (wasi_http_types_field_value_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
bool wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, target_list_field_value_t *value, wasi_http_types_header_error_t *err) {
...
void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, target_list_tuple2_field_name_field_value_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_fields_entries((self).__handle, ptr);
  *ret = (target_list_tuple2_field_name_field_value_t) { (target_tuple2_field_name_field_value_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_http_types_method_incoming_request_method(wasi_http_types_borrow_incoming_request_t self, wasi_http_types_method_t *ret) {
  ...
  switch ((int32_t) variant.tag) {
    ...
    case 9: {
      variant.val.other = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 4))), (*((size_t*) (ptr + 8))) };
      break;
    }
  }
  *ret = variant;
...
bool wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, target_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      option.is_some = true;
      option.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 4))), (*((size_t*) (ptr + 8))) };
      break;
    }
  }
  *ret = option.val;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 2: {
          variant.val.other = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 8))), (*((size_t*) (ptr + 12))) };
          break;
        }
      }
...
bool wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, target_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_method_outgoing_request_set_method(wasi_http_types_borrow_outgoing_request_t self, wasi_http_types_method_t *method) {
  ...
  switch ((int32_t) (*method).tag) {
    ...
    case 9: {
      const target_string_t *payload8 = &(*method).val.other;
      variant = 9;
...
bool wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, target_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, target_string_t *maybe_path_with_query) {
  target_option_string_t path_with_query;
  ...
  if ((path_with_query).is_some) {
    const target_string_t *payload0 = &(path_with_query).val;
    option = 1;
...
bool wasi_http_types_method_outgoing_request_set_scheme(wasi_http_types_borrow_outgoing_request_t self, wasi_http_types_scheme_t *maybe_scheme) {
  ...
  if ((scheme).is_some) {
    ...
    switch ((int32_t) (*payload0).tag) {
      ...
      case 2: {
        const target_string_t *payload3 = &(*payload0).val.other;
        variant = 2;
...
bool wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, target_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
bool wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, target_string_t *maybe_authority) {
  target_option_string_t authority;
  ...
  if ((authority).is_some) {
    const target_string_t *payload0 = &(authority).val;
    option = 1;
    option1 = (uint8_t *) (*payload0).ptr;
    option2 = (*payload0).len;
  } else {
...
bool wasi_http_types_method_request_options_connect_timeout(wasi_http_types_borrow_request_options_t self, wasi_http_types_duration_t *ret) {
  ...
  target_option_duration_t option;
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    case 0: {
      option.is_some = false;
      break;
...
bool wasi_http_types_method_request_options_set_connect_timeout(wasi_http_types_borrow_request_options_t self, wasi_http_types_duration_t *maybe_duration) {
  target_option_duration_t duration;
    ...
    switch ((int32_t) (*payload0).tag) {
      ...
      case 1: {
        ...
        if (((*payload2).rcode).is_some) {
          const target_string_t *payload4 = &((*payload2).rcode).val;
          option = 1;
      ...
      case 14: {
        ...
        if (((*payload23).alert_message).is_some) {
          const target_string_t *payload29 = &((*payload23).alert_message).val;
          option30 = 1;
      ...
      case 17: {
        const target_option_u64_t *payload35 = &(*payload0).val.http_request_body_size;
        int32_t option38;
        int64_t option39;
      ...
      case 21: {
        const target_option_u32_t *payload43 = &(*payload0).val.http_request_header_section_size;
        int32_t option46;
        int32_t option47;
      ...
      case 22: {
        ...
        if ((*payload48).is_some) {
          ...
          if (((*payload50).field_name).is_some) {
            const target_string_t *payload52 = &((*payload50).field_name).val;
            option53 = 1;
      ...
      case 23: {
        const target_option_u32_t *payload66 = &(*payload0).val.http_request_trailer_section_size;
        int32_t option69;
        int32_t option70;
      ...
      case 24: {
        ...
        if (((*payload71).field_name).is_some) {
          const target_string_t *payload73 = &((*payload71).field_name).val;
          option74 = 1;
      ...
      case 26: {
        const target_option_u32_t *payload82 = &(*payload0).val.http_response_header_section_size;
        int32_t option85;
        int32_t option86;
      ...
      case 27: {
        ...
        if (((*payload87).field_name).is_some) {
          const target_string_t *payload89 = &((*payload87).field_name).val;
          option90 = 1;
      ...
      case 28: {
        const target_option_u64_t *payload97 = &(*payload0).val.http_response_body_size;
        int32_t option100;
        int64_t option101;
      ...
      case 29: {
        const target_option_u32_t *payload102 = &(*payload0).val.http_response_trailer_section_size;
        int32_t option105;
        int32_t option106;
      ...
      case 30: {
        ...
        if (((*payload107).field_name).is_some) {
          const target_string_t *payload109 = &((*payload107).field_name).val;
          option110 = 1;
      ...
      case 31: {
        const target_option_string_t *payload117 = &(*payload0).val.http_response_transfer_coding;
        int32_t option120;
        uint8_t * option121;
        size_t option122;
        if ((*payload117).is_some) {
          const target_string_t *payload119 = &(*payload117).val;
          option120 = 1;
      ...
      case 32: {
        const target_option_string_t *payload123 = &(*payload0).val.http_response_content_coding;
        int32_t option126;
        uint8_t * option127;
        size_t option128;
        if ((*payload123).is_some) {
          const target_string_t *payload125 = &(*payload123).val;
          option126 = 1;
      ...
      case 38: {
        const target_option_string_t *payload134 = &(*payload0).val.internal_error;
        int32_t option137;
        uint8_t * option138;
        size_t option139;
        if ((*payload134).is_some) {
          const target_string_t *payload136 = &(*payload134).val;
          option137 = 1;
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              ...
              switch ((int32_t) variant.tag) {
                ...
                case 1: {
                  target_option_string_t option0;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option0.is_some = false;
                      break;
                    ...
                    case 1: {
                      option0.is_some = true;
                      option0.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u16_t option1;
                ...
                case 14: {
                  ...
                  target_option_string_t option3;
                  switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                    ...
                    case 1: {
                      option3.is_some = true;
                      option3.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                      break;
                    }
                  }
                  variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
                ...
                case 22: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option8.is_some = true;
                      target_option_string_t option6;
                      switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                        case 0: {
                          option6.is_some = false;
                          break;
                        ...
                        case 1: {
                          option6.is_some = true;
                          option6.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                          break;
                        }
                      }
                      target_option_u32_t option7;
                ...
                case 24: {
                  target_option_string_t option10;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option10.is_some = false;
                      break;
                    ...
                    case 1: {
                      option10.is_some = true;
                      option10.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u32_t option11;
                ...
                case 27: {
                  target_option_string_t option13;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option13.is_some = false;
                      break;
                    ...
                    case 1: {
                      option13.is_some = true;
                      option13.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u32_t option14;
                  switch ((int32_t) *((uint8_t*) (ptr + 44))) {
                    case 0: {
                      option14.is_some = false;
                      break;
                ...
                case 30: {
                  target_option_string_t option17;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option17.is_some = false;
                      break;
                    ...
                    case 1: {
                      option17.is_some = true;
                      option17.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u32_t option18;
                  switch ((int32_t) *((uint8_t*) (ptr + 44))) {
                    case 0: {
                      option18.is_some = false;
                      break;
                ...
                case 31: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option19.is_some = true;
                      option19.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                ...
                case 32: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option20.is_some = true;
                      option20.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                ...
                case 38: {
                  target_option_string_t option21;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option21.is_some = false;
                      break;
                    ...
                    case 1: {
                      option21.is_some = true;
                      option21.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 1: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option2.is_some = true;
              option2.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          target_option_u16_t option3;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
              option3.is_some = false;
              break;
        ...
        case 22: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option10.is_some = true;
              target_option_string_t option8;
              switch ((int32_t) *((uint8_t*) (ptr + 20))) {
                case 0: {
                  option8.is_some = false;
                  break;
                ...
                case 1: {
                  option8.is_some = true;
                  option8.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 24))), (*((size_t*) (ptr + 28))) };
                  break;
                }
              }
              target_option_u32_t option9;
        ...
        case 27: {
          target_option_string_t option15;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option15.is_some = false;
              break;
            ...
            case 1: {
              option15.is_some = true;
              option15.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          target_option_u32_t option16;
        ...
        case 31: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option21.is_some = true;
              option21.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 32: {
          target_option_string_t option22;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option22.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 38: {
          target_option_string_t option23;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option23.is_some = false;
              break;
            ...
            case 1: {
              option23.is_some = true;
              option23.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
              ...
              switch ((int32_t) variant.tag) {
                ...
                case 1: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option.is_some = true;
                      option.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u16_t option0;
                ...
                case 14: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                    ...
                    case 1: {
                      option2.is_some = true;
                      option2.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                      break;
                    }
                  }
                  variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      ...
                      switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                        ...
                        case 1: {
                          option5.is_some = true;
                          option5.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                          break;
                        }
                      }
                      target_option_u32_t option6;
                ...
                case 24: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option9.is_some = true;
                      option9.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u32_t option10;
                ...
                case 27: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option12.is_some = true;
                      option12.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u32_t option13;
                ...
                case 30: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option16.is_some = true;
                      option16.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  target_option_u32_t option17;
                ...
                case 31: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option18.is_some = true;
                      option18.val = (target_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  variant.val.http_response_transfer_coding = option18;
...
__attribute__((__export_name__("wasi:http/incoming-handler@0.2.2#handle")))
...
extern void __component_type_object_force_link_target(void);
void __component_type_object_force_link_target_public_use_in_this_compilation_unit(void) {
  __component_type_object_force_link_target();
}
